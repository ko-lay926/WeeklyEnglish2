...
"https://ko-lay926.github.io/WeeklyEnglish/www/quizzes.json"
);
...
// find latest week (last key in object)
const weeks = Object.keys(data);
const latestWeek = weeks[weeks.length - 1];

// only latest week is NEW
...
// assign SAME update date to ALL weeks in this update
...
const backup =
localStorage.getItem("quizBackup");
